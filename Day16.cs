...
namespace aoc_2021_csharp
{
    public class Day16
    {
        private static readonly string INPUT_FILE = "input/day16.txt";
        ...
        public void Part1()
        {
            ...
            Console.WriteLine($"Day 16, Part 1: {versionSum}");
        }
        ...
        private Node ReadPacket(Transmission transmission)
        {
        ...
        private Node ReadOperatorPacket(Transmission transmission, NodeType type)
        {
        ...
        private Node ReadLiteralValuePacket(Transmission transmission)
        {
            var number = "";
